...
function getSingletCombination()					       #FUNCTION FOR SINGLET COMBINATION
{
	...
	echo ""								       #CALCULATE THE PERCENTAGE OF EACH SINGLET
...
function getDoubletCombination() 					       #FUNCTION FOR DOUBLET COMBINATION
{
	...
	echo ""									#CALCULATE THE PERCENTAGE OF EACH DOUBLET
...
function getTripletCombination()						#FUNCTION FOR TRIPLET COMBINATION
{
	...
	echo ""									#CALCULATE THE PERCENTAGE OF EACH TRIPLET
...
function sortingTheValues() 							#FUNCTION IS TO DISPLAY COUNT OF COMBINATION
{										#AND SORTING THEM TO GET WIN COMBINATION
